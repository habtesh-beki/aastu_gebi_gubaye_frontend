...
export default function DetailInfo(){
    return (
        <div className="flex flex-col h-2/4 w-1/4 absolute top-1/4 left-1/3 border rounded-lg overflow-hidden">
            <Header/>
            <div className="grid grid-cols-2 px-8 pt-4 gap-4 text-lg">
            <div className="">
