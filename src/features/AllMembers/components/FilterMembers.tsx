        ...
        <div className="bg-white p-6 rounded-lg space-y-8">
            ...
            <div className="flex justify-between flex-col gap-6 min-[1200px]:gap-0 min-[1200px]:flex-row">
                ...
                <div className="text-blue-700 font-bold space-x-2 flex gap-4 items-center">
                    ...
                    <button className="text-md py-4 px-4 text-blue-700 bg-blue-100 rounded-lg border-[2.5px] border-blue-400 hover:bg-blue-700 hover:text-white hover:border-blue-700 focus-visible:ring-2 focus-visible:ring-blue-700 focus-visible:ring-offset-2" onClick={handleClearFilter}>
                        <FilterX />
                    </button>
                    <Dialog>
